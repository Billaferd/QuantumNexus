...
### A. Ability Cost Reference Table

| Ability Type | AP Cost | Activation Cost Modifier | Interrupt Type Modifier | Additional Cost Modifiers | Notes |
|---|---|---|---|---|---|
| Active Abilities |  |  |  |  |  |
| Increase Attack | 3 | -1 AP per 2 CP | N/A | +2 AP per additional effect | Varies based on attack stat, range, target (single vs. multiple), ignoring Defense, etc. |
| Destroy a Unit | 6 | -1 AP per 2 CP | N/A | +1 AP per additional unit | Higher cost for stronger units, Leaders, or units with specific keywords. |
| Draw Cards | 2 | -1 AP per 2 CP | N/A |  | Higher cost for drawing multiple cards, specific card types. |
| Discard Cards | 1 | -1 AP per 2 CP | N/A |  | Higher cost for discarding multiple cards, specific card types, or from opponent's hand. |
| Move Units | 2 | -1 AP per 2 CP | N/A |  | Higher cost for moving multiple units or to a specific location. |
| Grant a Buff/Debuff | 3 | -1 AP per 2 CP | N/A | +2 AP per additional target | Varies based on the strength, duration, and target of the effect. |
| Transform | 5 | -1 AP per 2 CP | N/A |  | Higher cost for more powerful or versatile transformations. |
| Counter or Cancel an Ability/Effect | 4 | -1 AP per 2 CP |  |  | Varies based on the power of the countered effect. |
| Special Effects (e.g., Stun, Poison, Silence) | 4 | -1 AP per 2 CP | N/A |  | Varies based on the strength, duration, and conditionality of the effect. |
| Conditional Effects | 2 | N/A | N/A |  | Lower cost for stricter conditions or less powerful effects. |
| Unique or Powerful Effects | 8 | -1 AP per 3 CP | N/A |  | High cost for game-changing abilities. Balance carefully to avoid overpowered cards. |
| Domain-Specific Abilities | 3 | -1 AP per 2 CP | N/A |  | Consider the domain's overall power and the ability's specific effect. |
| Additional Costs and Sacrifices | +2 AP per cost | N/A | N/A |  | Add AP for each additional CP cost, card sacrificed, or specific requirement (e.g., discarding an Upgrade, having a specific Terrain in play). |
| Interrupts |  |  |  |  |  |
| On Deploy | 1 | N/A | -1 AP |  | Triggered when the card itself is deployed. |
| On Attack | 3 | N/A | -2 AP |  | Triggered when the card attacks. |
| On Discard/Destroy | 2 | N/A | -1 AP |  | Triggered when the card is discarded or destroyed. |
| On Specific Condition (e.g., turn start/end) | 2 | N/A | -1 AP |  | Triggered under specific conditions not directly tied to actions. |
