...
During this phase, text must remain exceptionally concise, utilizing established Keywording wherever possible to reduce cognitive load and text density. Designers must also account for inherent spatial board mechanics; for instance, recognizing that units residing in their respective Deployment Zone (Row 1 or Row 5) cannot be targeted by Range 2 or greater attacks unless the attacker possesses the Artillery or Sniper keyword. This spatial protection must heavily influence the numeric Range, base Defense, and overall RP cost assigned to infrastructure and support-oriented units.
