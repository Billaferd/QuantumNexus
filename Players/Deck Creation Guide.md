...
​This dynamic is profoundly amplified by the game's dynamic initiative system. Initiative is not a passive reward; it is a volatile resource dictated by a live "Tug of War." The moment a player successfully destroys an enemy unit, they immediately seize the Initiative token for the following round. This creates a relentless pressure to engage. A player might intentionally deploy a low-cost, vulnerable unit—a sacrificial pawn—to bait the opponent into spending CP on an attack. If the opponent takes the bait but fails to destroy the target (only inflicting Impact and exhausting it), the player can immediately counter-attack with their remaining CP, score a kill, and steal the Initiative token right before the Activation Sequence ends. Mastering this delicate balance—knowing how to manipulate the 15 CP economy to engineer a final, lethal strike at the end of the round to steal Initiative for the next—is a hallmark of an expert Nexus Architect.
...
​Tempo, on the other hand, is the pace of play. It is the measure of how effectively a player uses their Command Points and actions within the game's alternating Activation Sequence to advance their board state relative to their opponent's. A critical and unique aspect of tempo in Quantum Nexus is the management of the "Tug of War" Initiative token. Because Initiative is immediately stolen upon destroying an enemy unit, tempo swings are intensely violent.

​This rule creates a direct and powerful link between spatial control and the flow of time. A player might deliberately execute a mathematically sub-optimal attack simply to secure a kill and steal the Initiative token. However, weaponizing aggression requires flawless spatial awareness. If the round devolves into a stalemate and an entire Activation Sequence ends without a single unit being destroyed, the Initiative defaults to the player who physically occupies the most quadrants in the neutral Contested Zone (Row 3). Therefore, you cannot simply hide in your Deployment Zone and refuse to fight. The highest level of strategic skill in Quantum Nexus is knowing exactly when to trade immediate CP for a tactical kill to steal Initiative, and when to physically push your units into the lethal center of the board to secure the fallback advantage without conceding critical Supremacy Points.
